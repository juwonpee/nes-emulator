...
cd /root/downloads/wx/wxWidgets/include              # go to wx include folder
...
wx_top_builddir="/root/projects/NES-emulator/src/libraries/wx"
top_srcdir="/root/downloads/wx/wxWidgets"
flags=" "
...
flags="-I . -I /root/downloads/wx/wxWidgets/include $flags -D__WXDEBUG__ -D__WXGTK__ -DWXBUILDING $allheaders"
